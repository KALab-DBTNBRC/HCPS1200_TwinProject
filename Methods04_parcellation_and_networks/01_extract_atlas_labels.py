...
# --- CONFIGURATION ---
ATLAS_PATH = os.path.join(os.environ.get("PROJECT_ROOT", "."), "Atlas/Q1-Q6_RelatedValidation210.CorticalAreas_dil_Final_Final_Areas_Group_Colors.32k_fs_LR_Tian_Subcortex_S3.dlabel.nii")
OUTPUT_KEY = os.path.join(os.environ.get("PROJECT_ROOT", "."), "Atlas/atlas_translation_key.csv")
